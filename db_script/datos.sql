...
INSERT INTO USUARIO (nombres, apellido_paterno, apellido_materno, fecha_nacimiento, sexo, correo, telefono, contrasena, departamento, especialidad, revisor_asignado, activo)
VALUES 
...
INSERT INTO EVALUACION_Practico (id_revisor_usuario, id_docente_usuario, id_portafolio, caratula, carga_academica, filosofia, cv, plan_sesiones, asistencia_alumnos, evidencia_actividades_ensenianza, registro_notas_practicas, proyecto_individual_grupal, fecha_de_revision)
VALUES 
(4, 5, 1, 'Completado', 'Pendiente', 'Observado', 'Completado', 'Pendiente', 'Observado', 'Completado', 'Pendiente', 'Completado', '2024-04-18');

INSERT INTO OBSERVACIONES (id_portafolio, observacion, fecha_observacion)
VALUES 
